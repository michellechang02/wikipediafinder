...
public class BFSTest {
    ...
    static class MockPageNode extends PageNode {
        ...
        @Override public Set<String> getOutLinks() { return outLinks.keySet(); }
        @Override public Set<PageNode> getOutNodes() { return new HashSet<>(outLinks.values()); }
        @Override public String getURL() { return url; }
        @Override public void setOutLinks(Map<String, PageNode> outLinks) { this.outLinks = outLinks; }
    }
